...
class GreeksParameters_kb(Black_Scholes_kb):
    def __init__(self,type_option, S0, K, r, t, volatility, dr, fr, divid, today, maturity_date,day_convention):
        Black_Scholes_kb.__init__(self, type_option, S0, K, r, t, volatility, dr, fr, divid, today, maturity_date,day_convention)
    ...
    def vega_fun(self,scope):
        ...
        for self.volatility in scope:
            ...
            d1 = (np.log(self.S0 / self.K) + (self.r - self.divid + 0.5 * self.volatility ** 2) * self.year_fraction_two_dates_fun()) / (
...
greeks=GreeksParameters_kb(type_option='call',
                                           S0=41,
                                           K=40,
                                           r=0.08,
                                           t=0,
...
delta_v=greeks.delta_fun(scope=[38,40,42])
gamma_v=greeks.gamma_fun(scope=[38,40,42])
vega_v=greeks.vega_fun(scope=[0.1,0.2,0.3])
print("The End")