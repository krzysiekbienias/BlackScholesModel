...
class Black_Scholes_kb(Calendar_kb):
    ...
    def modify_parameter(self,scope):
        print("Be sure what parameter you change and what is the scope")
...
# how option price is related to increase of underlying and decrease maturity
increace_price3m=o_black_scholes_3m.modify_parameter(scope=np.arange(35,46))[0]
increase_price7d=o_black_scholes_7d.modify_parameter(scope=np.arange(35,46))[0]
plt.plot(np.arange(35,46),increace_price3m)
plt.plot(np.arange(35,46),increase_price7d,'--')
