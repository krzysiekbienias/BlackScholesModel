...
if __name__ == '__main__':
    ...
    increace_price6m=o_black_scholes_6m.modify_parameter(scope=np.arange(30,50))[0]
    increace_price3m=o_black_scholes_3m.modify_parameter(scope=np.arange(30,50))[0]
    increase_price7d=o_black_scholes_7d.modify_parameter(scope=np.arange(30,50))[0]

    plt.plot(np.arange(30,50),increace_price6m, label="6m to maturity")
    plt.plot(np.arange(30,50),increace_price3m,label="3m to maturity")
